...
public class SecurityConfig {
	...
	SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		...
		authorize.antMatchers(HttpMethod.GET, "/api/v1/**").permitAll().antMatchers(HttpMethod.PUT, "/api/v1/**")
				.permitAll().antMatchers(HttpMethod.POST, "/api/v1/role/**").permitAll().antMatchers("/api/v1/auth/**")
				.permitAll().antMatchers(HttpMethod.POST, "/api/v1/employee/add").hasAuthority("ADMIN").anyRequest()
				.authenticated()
